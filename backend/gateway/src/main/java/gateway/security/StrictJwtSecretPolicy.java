...
/**
 * En modo estricto (Render, perfil prod, o SLOTONE_STRICT_JWT_SECRET=true), rechaza el secreto por
 * defecto del repo y exige tamaño suficiente tras decodificar Base64 (HS256 ≥ 256 bits).
 */
